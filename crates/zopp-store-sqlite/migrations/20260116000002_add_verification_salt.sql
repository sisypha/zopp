...
ALTER TABLE principal_exports ADD COLUMN verification_salt BLOB;
...
UPDATE principal_exports SET verification_salt = randomblob(16) WHERE verification_salt IS NULL;
